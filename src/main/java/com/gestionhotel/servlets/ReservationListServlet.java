...
@WebServlet(name = "ReservationListServlet", value = "/reservations/mine")
public class ReservationListServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Reservation> reservations = reservationDao.findByClient(utilisateur);
        request.setAttribute("reservations", reservations);
        request.getRequestDispatcher("/reservation/mine.jsp").forward(request, response);
    }
}
